    ...
    >
      ...
      <div className="relative rounded-[34px] overflow-hidden bg-[#090a0f] aspect-[9/19.5] border border-neutral-800/80">
        <Image
          ...
          alt={alt}
          fill
          sizes="(max-width: 640px) 220px, (max-width: 768px) 270px, 290px"
...
export function HeroDeck() {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto h-[460px] sm:h-[580px] md:h-[640px] mt-10 mb-8 perspective-[1200px]">
      {/* Timer */}
      <ItemCelular
      ...
      {!aberto && (
        <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-xs text-neutral-400 bg-neutral-900/80 px-4 py-1.5 rounded-full border border-neutral-800 animate-bounce">
